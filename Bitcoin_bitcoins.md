...
4. un **réseau de paiement** : le débat sur la [scalabilité de Bitcoin](https://en.wikipedia.org/wiki/Bitcoin_scalability_problem) a mis en évidence que les choix techniques faits dans Bitcoin n'étaient pas compatibles avec son utilisation comme un réseau de paiement utilisé par une majorité de la population pour ses achats quotidiens. Faire de Bitcoin un réseau de paiement avec la même capacité que Visa ne pourra se faire qu'en rendant prohibitif l'entretien d'un noeud sur le réseau, et en perdant par conséquent les bénéfices de la décentralisation. 
